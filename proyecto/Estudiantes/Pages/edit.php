...
<body>
    ...
    <form action="../Controladores/edit.php" method="POST">
        ...
        Documento <br>
        <input type="text" name="Documento" required="" autocomplete="off" placeholder="Documento" id="" value="<?php echo $Info['DOCUMENTO']; ?>"> <br> <br>
        Correo <br>
        <input type="email" name="Correo" required="" autocomplete="off" placeholder="Correo" id="" value="<?php echo $Info['CORREO']; ?>"> <br> <br>
        Materia <br>
        ...
        Docente <br>
        <input type="number" name="Promedio" required="" autocomplete="off" placeholder="Promedio" id="" value="<?php echo $Info['PROMEDIO']; ?>"> <br> <br>
